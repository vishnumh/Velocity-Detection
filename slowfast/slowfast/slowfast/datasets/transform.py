...
def random_short_side_scale_jitter(
    ...
    new_width = size
    new_height = size
    if width < height: # GAO: 20220221 add "=" for experiment, 0202 change back
    ...
    new_height = int(np.random.uniform(224, 256))
    new_width = int(np.random.uniform(224, 320))
    #print("*/"*500, new_height, new_width)
...
def random_crop(images, size, boxes=None):
    ...
    print("*"*500, cropped.shape, cropped_boxes)
